...
from model_my_variant3 import CDAE, Discriminator, save_embedding_process
import time
import itertools
import pandas as pd
...
'''
variant of my. Set W1, W2 are two-layer non-linear transformation
'''

method_name = 'my_variant3'
...
parser.add_argument('--reg', type=float, default=1.0, help='lambda reg always 0.0 for this variant')
